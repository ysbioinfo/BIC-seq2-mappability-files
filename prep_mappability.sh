...
source /home/shiyang/softwares/bicseq_mappability_script/utils.sh
GEMD="/home/shiyang/softwares/GEM-binaries-Linux-x86_64-core_i3-20130406-045632/bin"   # location GEM packages installed

# Added by Yang, or it will throws out an Fatal error
export PATH=$GEMD:${PATH}
# Set defaults
THREADS_INDEXER=4
THREADS_MAPPABILITY=16
READ_LENGTH=150
...
while read CHR; do
    ...
    # \b is added by Yang. Or it will give you wrong results
